                ...
                // TODO Auto-generated method stub
                 try {
                     ...
                     String newName = request.getParameter("newname");
          			 ...
          			 float newPrice = Float.parseFloat(priceString);	 
                        SessionFactory factory = HibernateUtil.getSessionFactory();
                        
                        Session session = factory.openSession();
                        session.beginTransaction();
                        EClothes newClothing = new EClothes();
                        newClothing.setName(newName);
                        newClothing.setPrice(newPrice);
                        newClothing.setSize(newSize);
                        session.save(newClothing);
                        session.getTransaction().commit();
                        session.close();
                        out.println(newName+ " was added.");
